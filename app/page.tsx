  ...
  return (
    <>
      ...
      <main>
        ...
        {/* runway values below are sized for Anushka's actual item counts
            (3 projects, 1 role, 4 credentials) — the originals (4.5/4.4/3.5)
            were tuned for Gireesh's much longer lists (~14/~5/~5) and left
            long dead-scroll stretches once the content shrank. */}
        <Scene order={6} runway={1.8} id="work">
          <Work />
        </Scene>

        <Scene order={7} runway={1.2} id="experience">
          <Experience />
        </Scene>
