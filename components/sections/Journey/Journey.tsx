...
const CHAPTERS: Chapter[] = [
  {
    ...
    title: (
      <>
        I&rsquo;m Anushka — I build products that{" "}
        <em className={styles.serif}>work.</em>
      </>
    ),
    body: "Computer Science undergraduate at Heritage Institute of Technology, Kolkata, building and deploying full-stack web applications with React, TypeScript, Node.js and PostgreSQL/MongoDB.",
  },
  {
    label: "My Journey",
    title: (
      <>
        I came to engineering through{" "}
        <em className={styles.serif}>building things.</em>
      </>
    ),
    body: "A finance tracker, a safety app, an internship, an interview platform — each project taught the next lesson about shipping real software.",
  },
  {
    label: "Engineering Philosophy",
    title: (
      <>
        Strong fundamentals. Clean,{" "}
        <em className={`${styles.serif} ${styles.red}`}>working code.</em>
      </>
    ),
    body: "DS&A first, then production systems. Ship, review, iterate — code that a teammate can read and trust.",
  },
  {
    label: "Full-Stack × Systems",
    title: (
      <>
        Every feature has an API — and a{" "}
        <em className={styles.serif}>user.</em>
      </>
    ),
    body: "From Firebase Authentication to PostgreSQL schemas, I build the whole path from interface to data, not just the parts that show.",
  },
  {
    label: "Teamwork",
    title: (
      <>
        Led a team of <em className={`${styles.serif} ${styles.red}`}>4.</em>{" "}
        Won a hackathon.
      </>
    ),
    body: "1st place at Hack Heritage 3.0 among 300 teams, building Her Voice — a real-time women's safety alert app.",
  },
  {
    label: "My Process",
    title: (
      <>
        Design → build →{" "}
        <em className={styles.serif}>review</em> → deploy.
      </>
    ),
    body: "I scope the problem, build against real APIs, review pull requests carefully, and ship with CI/CD.",
  },
  {
    label: "Vision",
    title: (
      <>
        Building for what&rsquo;s{" "}
        <em className={`${styles.serif} ${styles.red}`}>next.</em>
      </>
    ),
    body: "Seeking an SDE Internship or New Grad SWE role to apply strong DS&A fundamentals to production systems.",
  },
];
