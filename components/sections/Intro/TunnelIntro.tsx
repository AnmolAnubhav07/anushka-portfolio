 ...
 * "ANUSHKA", stretched into a ~5.5-viewport cinematic journey that hands
...
export default function TunnelIntro({ text = "ANUSHKA" }: { text?: string }) {
  ...
  return (
    <section className={styles.intro} id="intro" ref={rootRef}>
      <div className={styles.frame} ref={frameRef}>
        ...
        <h1 className={styles.srOnly}>{text} — Full-Stack Developer &amp; CS Undergraduate</h1>
