...
const STATS_LEFT = [
  ...
  { n: 1, suffix: "", key: "stat.years", icon: "/images/icons/years.png" },
];
const STATS_RIGHT = [
  { n: 300, suffix: "+", key: "stat.countries", icon: "/images/icons/countries.png" },
  { n: 7000, suffix: "+", key: "stat.satisfaction", icon: "/images/icons/satisfaction.png" },
];
      ...
      <div className={styles.stageRow}>
        ...
        <div className={styles.stage}>
          ...
          <Image
            ...
            src="/images/anushka/portrait.jpg"
            alt="Anushka Kumari — Full-Stack Developer"
            width={430}
            height={573}
            priority
            data-depth="0.03"
