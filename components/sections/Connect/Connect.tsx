...
/* Anushka's own photographs (a subset of the 8 supplied candids), reused
   here from public/images/anushka. `focus` is object-position only: the
   frames are portrait and one photo is landscape, so this keeps her in
   frame — the images are cropped, never scaled non-uniformly, and their
   colour is left untouched. */
const PANELS = [
  { src: "/images/anushka/photo-02.jpg", focus: "58% 30%", rotate: 26, z: -110, y: -26 },
  { src: "/images/anushka/photo-03.jpg", focus: "center 32%", rotate: 13, z: -40, y: -8 },
  { src: "/images/anushka/photo-04.jpg", focus: "center 34%", rotate: 0, z: 0, y: 0 },
  { src: "/images/anushka/photo-05.jpg", focus: "center 30%", rotate: -13, z: -40, y: -8 },
  { src: "/images/anushka/photo-07.jpg", focus: "46% 32%", rotate: -26, z: -110, y: -26 },
];
...
const SOCIALS = [
  { name: "LinkedIn", mark: "linkedin", href: "https://www.linkedin.com/in/anushka-l-00b7a5249" },
  { name: "GitHub", mark: "github", href: "https://github.com/AnushkaLaheri" },
  { name: "Email", glyph: "@", href: "mailto:anushkalaheri@gmail.com" },
] as const;
    ...
    <section className={styles.connect} id="contact" ref={root}>
      <div className={styles.head}>
        ...
        <div className={styles.cta}>
          <Button href="mailto:anushkalaheri@gmail.com" variant="primary" arrow>
            {t("connect.cta")}
          </Button>
        </div>
      </div>
      ...
      <footer className={styles.footer}>
        <span>
          {t("connect.credit")} <b>Anushka</b>
        </span>
        <a href="#home" className={styles.top}>
          {t("connect.top")}
        </a>
        <span>© 2026 Anushka Kumari</span>
      </footer>
    </section>
  );
}
