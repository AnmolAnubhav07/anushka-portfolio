...
Personal portfolio of **Anushka Kumari**, Full-Stack Developer & CS
undergraduate (Kolkata, India). A single-page cinematic experience: full-screen
scenes stacked on top of each other, each one rising over the last as you
scroll, with scroll-driven set pieces inside them.

**Profiles:** [LinkedIn](https://www.linkedin.com/in/anushka-l-00b7a5249) ·
[GitHub](https://github.com/AnushkaLaheri)
...
1. **Intro** — Three.js gallery tunnel travelled through the "ANUSHKA" mask
2. **Hero** — headline, stats, CTAs
3. **About** — identity, philosophy, velocity marquee
4. **Journey** — five resume chapters (2020–2026) inside a light-cable tunnel
5. **Dev Stack** — tool spiral
6. **Work** — 3 selected projects on a perspective card arc, each with a
   case-study route at `/work/[slug]`
7. **Experience** — one role (Spacenos internship) as a stacked panel deck
8. **Credentials** — certification records, right-to-centre deck
9. **Gallery** — *The People Behind the Work*: 8 photographs on a drifting wall
...
content/        typed content: projects, journey, experience, certifications,
                gallery, stack
lib/            gsap/lenis integration, scene scrub helper, site meta
